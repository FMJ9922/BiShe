...
Shader "Toony Colors Pro 2/Examples/SG2/Leaves Wind"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
	...
	SubShader
	{
		...
		void surf(Input input, inout SurfaceOutputCustom output)
		{
			...
			output.Albedo *= ( __mainColor * input.vFace.xxxx ).rgb;
		}
