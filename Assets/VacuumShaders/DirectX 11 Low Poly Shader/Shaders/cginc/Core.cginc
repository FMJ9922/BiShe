...
//#ifdef V_LP_PAPERCRAFT
//inline fixed4 GetLowpolyPixelColor(float2 uv, fixed4 vColor, fixed3 mass)
//#else
...
//#endif
{
	...
	//	lowpolyColor.rgb = lerp(lerp(lowpolyColor.rgb, _V_WIRE_Color, _V_WIRE_Color.a), lowpolyColor.rgb, value);
	//#endif
